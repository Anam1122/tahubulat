...
function AboutPage() {
  return (
    <div className="container mx-auto p-8 py-12 min-h-[calc(100vh-160px)]">
      <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">Tentang AgriNuklir Platform</h1>

      <div className="bg-white rounded-lg shadow-xl p-8 max-w-3xl mx-auto">
        <h2 className="text-3xl font-semibold text-green-700 mb-6">Misi Kami</h2>
        ...
        <h2 className="text-3xl font-semibold text-green-700 mb-6 mt-8">Visi Kami</h2>
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-semibold text-green-700 mb-6 mt-8">Apa yang Kami Tawarkan?</h2>
